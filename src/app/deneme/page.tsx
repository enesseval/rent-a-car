...
import { BsFuelPumpFill, BsPerson, BsPersonCheckFill, BsPersonFill, BsPersonPlusFill } from "react-icons/bs";
...
//http://localhost:3000/deneme?from=2024-08-12&to=2024-08-17
...
function Reservation() {
   ...
   const v = {
      ...
      gear: "manuel",
      daily_price: "1350",
      image: "https://i.ibb.co/LzN9Zh3/egea-sd-limited-removebg-preview.png",
   };
   ...
   const handleClick = (service: ServiceKeys) => {
      setSelectedServices((prevState) => {
         ...
         }, daysBetween * Number(v?.daily_price) || 0);
   ...
   return (
      <div>
         ...
         <div className="w-full relative">
            <div className="grid grid-cols-3 md:grid-cols-5 gap-3 max-w-[1100px] mx-auto p-2">
               {/* Araç kartı */}
               <div className="col-span-3 p-2 border rounded-lg self-start">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                     <div className="col-span-2 sm:col-span-1 relative aspect-video">
                        <Image className="object-contain" src={v.image} alt={v.id} fill sizes="(max-width: 646px) 100vw, 33vw" />
                     </div>
                        ...
                        <div className="w-full sm:mt-3 flex flex-col justify-center sm:items-start items-center">
                           ...
                           <div className="grid grid-cols-3 w-full p-4 md:p-2 gap-2 sm:justify-items-start">
                              <span className="flex flex-col justify-center items-center col-span-1">
                                 ...
                                 {v.gear.charAt(0).toUpperCase() + v.gear.slice(1)}
                              </span>
                              <span className="flex flex-col justify-center items-center col-span-1">
                                 <BsFuelPumpFill className="w-5 h-5 mr-2" />
                                 {v.fuel.charAt(0).toUpperCase() + v.fuel.slice(1)}
                              </span>
                              <span className="flex flex-col justify-center items-center col-span-1">
               ...
               <div className="col-span-3 md:col-span-2 order-last md:order-none">
                  <div className="col-span-3 md:col-span-2 border rounded-lg p-5 order-last md:order-none">
                     ...
                     <h1 className="text-lg mt-5">
                        {daysBetween} günlük toplam tutar: <span>{daysBetween * Number(v?.daily_price)}₺</span>
                     </h1>
                     <p className="text-xs mt-3 mb-5">Günlük kiralama tutarı: {Number(v?.daily_price)}₺</p>
                     <Separator />
                     <div className="w-full border rounded-md mt-10 mx-auto p-3 flex bg-slate-200 dark:bg-slate-800">
                        ...
                        <div className="max-w-[80%]">
                           <p>
                              Araç teslimatı sırasında tahsil edilecek depozito ücreti için <span className="font-bold">kendi adınıza ait kredi kartınızı, kimliğinizi ve ehliyetinizi</span> yanınızda
                              bulundurmalısınız.
                           </p>
                        </div>
                     </div>
                     <div className="md:absolute md:bottom-3 md:right-3 md:border md:rounded-lg md:p-2">
                        ...
                        <Popover>
                           <PopoverTrigger id="birthday" asChild>
                              <Button variant={"outline"} className={cn("w-full justify-start text-left font-normal", !date && "text-muted-foreground")}>
                                 ...
                                 {date ? format(date, "PPP") : <span>Doğum tarihi seçiniz.</span>}
                              </Button>
                           </PopoverTrigger>
